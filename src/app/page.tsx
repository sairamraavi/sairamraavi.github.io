...
const learning = [
  ...
  "Future focus: DevSecOps, observability & platform engineering",
];
const principles = [
  [
    "Understand the problem",
    "Translate product, user and business requirements into a clear engineering plan.",
  ],
  [
    "Build for maintainability",
    "Prefer reusable components, readable code, modular architecture and documented decisions.",
  ],
  [
    "Automate repeatable work",
    "Use CI/CD pipelines, containers and infrastructure automation to reduce manual deployment effort.",
  ],
  [
    "Operate what is built",
    "Use logs, monitoring, health checks and root-cause analysis to improve reliability.",
  ],
];
...
export default function Home() {
  const person = {
    ...
    url: "https://sairamraavi.github.io",
  ...
  return (
    <>
      ...
      <main id="main">
        <section id="top" className="hero section">
          <div className="hero-copy">
            ...
            <div className="hero-meta">
              ...
              <span>
                Open to senior full-stack and DevOps-focused opportunities
              </span>
            </div>
          </div>
          <div className="hero-visual">
            <div className="portrait-wrap">
              <Image
                src="/images/sairam-profile.jpeg"
                alt="Sairam Raavi"
                width={700}
                height={900}
                priority
        ...
        <section id="about" className="section summary">
          ...
          <div>
            ...
            <div className="metrics">
              <span>
                <b>7+</b> years in software engineering
              </span>
              <span>
                <b>Full stack</b> frontend, backend & CMS
              </span>
              <span>
                <b>Applied labs</b> CI/CD & cloud automation
              </span>
            </div>
          </div>
        </section>
        ...
        <section id="learning" className="section learning">
          ...
          <div>
            ...
            <p>
              Practical engineering-lab work extending from full-stack
              development into cloud and platform delivery.
            </p>
            <ol>
              {learning.map((item, i) => (
                <li key={item}>
            ...
            <p className="learning-note">
              Applied topics include Docker multi-stage builds, Flask and
              Node.js containerization, AWS EC2/ECR/S3/IAM, EKS, Helm, CSI
              drivers, Lambda automation, EventBridge, CloudWatch and Terraform.
            </p>
          </div>
        </section>
        ...
        <section className="section github">
          ...
          <div>
            ...
            <p>
              Explore project repositories spanning Docker, Jenkins, AWS,
              Kubernetes, Terraform and full-stack service patterns.
            </p>
        ...
        <section className="section education">
          ...
          <div className="credential">
            <div>
              ...
              <p>NRI Institute of Technology · Graduated 2016</p>
            </div>
            <div>
              <p className="eyebrow">Credentials</p>
              <p>
                <b>DevOps learning program</b> — In progress
              </p>
              <p>Future AWS and Kubernetes certifications — Planned</p>
            </div>
          </div>
        </section>
        <ContactSection />
      ...
      <footer>
        ...
        <div>
          <a href="/blog/">Blog</a>
          <a href="/resume/sairam-raavi-resume.pdf">Resume</a>
          <a href={profile.github}>GitHub</a>
          <a href={`mailto:${profile.email}`}>Email</a>
        </div>
        <p>
          © {new Date().getFullYear()} · Designed and engineered with Next.js
          and TypeScript
        </p>
      </footer>
    </>
